...
import { View, SafeAreaView, Text, StyleSheet, TouchableOpacity, Image, Alert } from 'react-native';
  ...
  return (
    <SafeAreaView style={[styles.container]}>
      ...
      <View style={styles.header}>
        <View style={{width: 100}}><CustomButton text= "<" href='AwarenessScreen' type="blackBackButton"/></View>
