...
const BreathingScreen = ({ navigation }) => {
  ...
  const handlePress = () => {
    const playSound = (sound) => {
      ...
      const play = (successCallback) => {
        sound.play(successCallback);
      };
    ...
    navigation.navigate('Timer', { music, cycle });

    switch (music) {
      case 'Waves':
        playSound(gentle_waves);
        break;
      case 'Rain':
        playSound(gentle_rain);
        break;
      case 'Fire':
        playSound(gentle_fire);
        break;
      case 'Forest':
        playSound(gentle_rainforest);
        break;
      case 'Meditation':
        playSound(med_sleep);
        break;
      case 'Birds':
        playSound(birds_forest);
        break;
      default:
